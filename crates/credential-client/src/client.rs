...
use credential_core::{LockState, SecretBytes};
use credential_ipc::{read_response, write_request, IpcRequest, IpcResponse};
use std::path::{Path, PathBuf};
use tokio::net::UnixStream;

pub const DEFAULT_SOCKET_SUBPATH: &str = "credentiald/native.sock";
...
impl CredentialClient {
    ...
    /// Creates a client connecting to the default `$XDG_RUNTIME_DIR/credentiald/native.sock`.
