...
pub fn spawn_lock_listener(service: CredentialService, _data_dir: PathBuf) {
...
async fn run_lock_listener(service: CredentialService) -> Result<(), Box<dyn std::error::Error>> {
