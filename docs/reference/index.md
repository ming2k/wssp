...
Reference documents provide exact, authoritative technical specifications, protocols, and data formats for `credentiald`.
...
- [CLI Reference](cli.md): Commands, options, and behaviors of `credentiald-cli`.
