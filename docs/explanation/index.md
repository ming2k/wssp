...
Explanation documents provide conceptual context, design rationale, and background architecture for `credentiald`.
...
- [Freedesktop Specifications](freedesktop-spec.md): How `credentiald` satisfies Secret Service and Portal Secret specifications.
